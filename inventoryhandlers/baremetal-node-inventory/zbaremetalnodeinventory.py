...
from nokia.cmframework.apis import cmansibleinventoryconfig
from nokia.cmdatautils.api import utils
    ...
    def handle(self):
        ...
        for host, hostvars in host_locals.iteritems():
            ...
            power = {
                ...
                "virtmedia_deploy_iso": "file:///opt/nokia/images/ironic-deploy.iso",
            }
            ...
            if utils.is_virtualized():
                ...
                power["ssh_key_contents"] = "{{ lookup('file', '/opt/nokia/userconfig/id_rsa') }}"
