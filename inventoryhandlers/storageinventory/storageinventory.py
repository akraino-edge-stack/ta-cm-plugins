...
class storageinventory(cmansibleinventoryconfig.CMAnsibleInventoryConfigPlugin):
    ...
    def _ceph_keys(self):
        return {
            'client.shared': os.system("ceph-authtool --gen-print-key"),
            'client.glance': os.system("ceph-authtool --gen-print-key"),
            'client.cinder': os.system("ceph-authtool --gen-print-key"),
            'client.caas':   os.system("ceph-authtool --gen-print-key")
        }
